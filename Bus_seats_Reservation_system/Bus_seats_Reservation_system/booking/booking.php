...
<div class="field">  
    <label>Traveling Class</label><span><a href="home.php"></a><i></i></span>
 <div class="field">
    <select name="gender" required id="travelclass">
      <option value="" selected disabled>--Travel Class--</option>
      <option>Single</option>
      <option>Double-aisle</option>
	   <option>Double-window</option>
...
<div class="ui icon input">
  ...
  <div class="field"> 
<label>Confirm Amount(RM)</label>
<div class="ui icon input">
<select name="gender" required id="amount">
      <option value="" selected disabled>--Amount--</option>
      <option>Single-RM50.00</option>
      <option>Double-aisle-RM55.00</option>
	   <option>Double-window-RM55.00</option>
