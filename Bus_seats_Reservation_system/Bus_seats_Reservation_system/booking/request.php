...
$checkcode=mysqli_query($conn,"SELECT seats_reserved FROM booking_details WHERE seats_reserved='$seats'");  
//($conn,"SELECT order_ref FROM booking_details WHERE order_ref='$order'");  
if((!$checkcode) || (mysqli_num_rows($checkcode) >0)){    
$message.="The Seat Reference #$seats Received belongs to another customer, Click <a href='index.php'>here</a> to generate another one. ";  
//$message.="The Order Reference #$order   
}    
